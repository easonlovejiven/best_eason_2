Rails.application.configure do
  ...
  # config.action_controller.asset_host = 'http://www.owhat.cn'
  config.assets.cache_store = :redis_store, "redis://#{Rails.application.secrets.redis_host}:6980/0/cache_store", { expires_in: 90.minutes }
  ...
  :email => {
    ...
    :exception_recipients => Rails.env.production? ? %w{saler_alert@owhat.cn} : %w{alert_poduction@owhat.cn},
...
Rails.application.routes.default_url_options[:host] = 'http://www.owhat.cn'
