class Manage::Welfare::ProductsController < Manage::PatternsController
  ...
  def index
    ...
    if ((params["where"] || {})["title"] || {})["like"].present?
      ...
      query_option = {where: {active: true, shop_type: "Welfare::Product"}, order: {created_at: :desc}, fields: [:title], limit: limit, offset: offset, page: params[:page] || 1}
