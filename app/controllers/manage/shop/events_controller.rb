class Manage::Shop::EventsController < Manage::PatternsController
  ...
  def index
    ...
    if ((params["where"] || {})["title"] || {})["like"].present?
      ...
      query_option = {where: {active: true, shop_type: "Shop::Event"}, fields: [:title], limit: limit, offset: offset, page: params[:page] || 1}
